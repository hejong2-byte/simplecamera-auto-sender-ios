...
final class ForegroundReceiveContractTests: XCTestCase {
    ...
    func testStorageManagementBrowsesAndSendsSelectedFilesToSavedReceiver() throws {
        ...
        XCTAssertTrue(storage.contains("model.toggleStorageEntrySelection"))
        XCTAssertTrue(storage.contains("model.toggleAllVisibleStorageEntries"))
        XCTAssertTrue(storage.contains("model.deleteSelectedStorageFiles"))
