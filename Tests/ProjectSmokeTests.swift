...
final class ProjectSmokeTests: XCTestCase {
    ...
    func testReleaseVersionAndFilesVisibilityContract() throws {
        ...
        XCTAssertTrue(project.contains("CURRENT_PROJECT_VERSION: 36"))
        XCTAssertTrue(project.contains("MARKETING_VERSION: 0.3.25"))
    ...
    func testReleaseDocumentsRepeatPromptAndDirectZIPExtraction() throws {
        ...
        XCTAssertTrue(readme.contains("현재 버전은 0.3.25(빌드 36)"))
    }
